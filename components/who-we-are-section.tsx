			...
			<div className='max-w-5xl mx-auto relative z-10'>
				...
				>
					...
					<motion.div
						...
						viewport={{ once: true }}
						className='space-y-8 font-body text-lg text-primary/80 leading-relaxed'
					>
						<p className='text-center lg:text-left'>
							Founded in 2009,{' '}
							<span className='font-semibold text-primary'>ARTIFEX GROUP</span>{' '}
							is an international architecture and development company dedicated
							to creating spaces that inspire and improve lives.
						</p>
						...
						<div className='p-8 lg:p-10'>
							<p className='text-center lg:text-left mb-6'>
								Our team is a family of professionals united by a shared vision:
							</p>
							<p className='text-center lg:text-left font-medium text-primary text-xl lg:text-2xl leading-relaxed'>
