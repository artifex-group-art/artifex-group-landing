...
interface WhoWeAreImageUploadProps {
	onUploadSuccess: (image: WhoWeAreImage) => void
	onUploadError: (error: string) => void
}

export default function WhoWeAreImageUpload({
	onUploadSuccess,
	onUploadError,
}: WhoWeAreImageUploadProps) {
	...
	const handleFileUpload = async (file: File) => {
		...
		try {
			...
			const saveResponse = await fetch('/api/who-we-are-images', {
				method: 'POST',
				headers: {
			...
			const uploadedImage = await saveResponse.json()
